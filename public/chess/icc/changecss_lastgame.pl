...
open(DAT, "/root/www/ralphweb/public/chess/icc/lastflag.txt");
my $data = <DAT>;
close(DAT);
...
if ($flipped eq 'true') {
	system("cp /root/www/chartbot/heatmapblack.gif /root/www/ralphweb/public/chess/icc/heatmap.gif");
} else {
	system("cp /root/www/chartbot/heatmapwhite.gif /root/www/ralphweb/public/chess/icc/heatmap.gif");
}
